"""
Upstage provider — Solar models for enterprise AI.

Sign up: https://console.upstage.ai
"""
...
class UpstageProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.upstage.ai/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "solar-1-mini-chat"
...
register("upstage", UpstageProvider)
