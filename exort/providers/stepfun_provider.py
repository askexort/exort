"""
StepFun provider — Step AI's inference API (step models).

Sign up: https://platform.stepfun.ai
"""
...
class StepfunProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.stepfun.ai/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "step-3.5-flash"
...
register("stepfun", StepfunProvider)
