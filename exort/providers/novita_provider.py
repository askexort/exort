"""
NovitaAI provider — affordable inference API with many models.
...
class NovitaProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.novita.ai/openai/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "deepseek/deepseek-v3-0324"
...
register("novita", NovitaProvider)
