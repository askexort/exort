"""
Databricks provider — DBRX and custom model serving endpoints.

Sign up: https://www.databricks.com
"""
...
class DatabricksProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        ...
        default_url = f"https://{host}/serving-endpoints" if host else ""
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "dbrx-instruct"
    ...
    def ok(self):
        return bool(self._c and self.api_key and os.environ.get("DATABRICKS_HOST"))


register("databricks", DatabricksProvider)
