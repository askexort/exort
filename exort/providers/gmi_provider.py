"""
GMI Cloud provider — affordable GPU cloud inference.

Sign up: https://www.gmicloud.ai
"""
...
class GmiProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.gmi-serving.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "deepseek-ai/DeepSeek-R1"
