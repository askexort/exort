"""
Nous Research provider — open-source model inference portal.

Sign up: https://inference.nousresearch.com
"""
...
class NousProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://inference.nousresearch.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "Hermes-3-Llama-3.1-70B"
