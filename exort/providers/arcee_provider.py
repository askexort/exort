"""
Arcee AI provider — enterprise AI with custom fine-tuned models.

Sign up: https://www.arcee.ai
"""
...
class ArceeProvider(BaseProvider):
    name = "arcee"

    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.arcee.ai/api/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "arcee-spotlight"
