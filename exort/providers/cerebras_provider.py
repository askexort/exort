"""
Cerebras provider — free, ultra-fast inference on dedicated hardware.
...
class CerebrasProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.cerebras.ai/v1"
        try:
...
register("cerebras", CerebrasProvider)
