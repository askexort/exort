"""
Kimi provider — Moonshot's Kimi coding and reasoning models.
...
class KimiProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.moonshot.ai/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "kimi-k2"
