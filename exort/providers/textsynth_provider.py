"""
TextSynth provider — inference API with various open models.

Sign up: https://textsynth.com
"""
...
class TextsynthProvider(BaseProvider):
    name = "textsynth"

    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.textsynth.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "Mistral-7B-v0.3"
...
register("textsynth", TextsynthProvider)
