"""
Mistral AI provider — European AI, strong reasoning.

Sign up: https://console.mistral.ai  (free tier available)
"""
...
class MistralProvider(BaseProvider):
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "mistral-large-latest"
