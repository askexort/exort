...
Sign up: https://openrouter.ai  (free models available)
"""
...
class OpenRouterProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        ...
        try:
            ...
            self._c = OpenAI(
                ...
                default_headers={"HTTP-Referer": "https://github.com/exort/exort"},
            )
        except ImportError:
            self._c = None
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "meta-llama/llama-3.3-70b-instruct:free"
