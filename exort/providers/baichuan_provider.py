"""
Baichuan AI provider — Chinese LLM company.

Sign up: https://platform.baichuan-ai.com
"""
...
class BaichuanProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.baichuan-ai.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "Baichuan4"
...
register("baichuan", BaichuanProvider)
