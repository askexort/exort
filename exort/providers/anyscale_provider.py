"""
Anyscale provider — scalable inference endpoints.

Sign up: https://www.anyscale.com
"""
...
class AnyscaleProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.endpoints.anyscale.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "meta-llama/Meta-Llama-3.1-70B-Instruct"
...
register("anyscale", AnyscaleProvider)
