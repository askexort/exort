"""
AI21 Labs provider — Jamba and Jurassic models.

Sign up: https://www.ai21.com
"""
...
class Ai21Provider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.ai21.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "jamba-1.5-large"
