"""
NVIDIA NIM provider — NVIDIA's inference microservices.
...
class NvidiaProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://integrate.api.nvidia.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "nvidia/llama-3.3-nemotron-super-49b-v1"
