"""
Together AI provider — fast inference for open models.

Sign up: https://api.together.xyz  (free tier available)
"""
...
class TogetherProvider(BaseProvider):
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo"
