"""
Volcengine provider — ByteDance's cloud API (Doubao models).

Sign up: https://console.volcengine.com/ark
"""
...
class VolcengineProvider(BaseProvider):
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "doubao-1.5-pro-256k"
...
register("volcengine", VolcengineProvider)
