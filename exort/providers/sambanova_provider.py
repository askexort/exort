"""
SambaNova provider — free, fast inference on RDU chips.
...
class SambanovaProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.sambanova.ai/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "Meta-Llama-3.1-8B-Instruct"
...
register("sambanova", SambanovaProvider)
