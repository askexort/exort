"""
Writer provider — enterprise AI with Palmyra models.
...
class WriterProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.writer.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "palmyra-x-004"
...
register("writer", WriterProvider)
