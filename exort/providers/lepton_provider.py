"""
Lepton AI provider — fast inference for popular models.

Sign up: https://www.lepton.ai
"""
...
class LeptonProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.lepton.ai/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "llama-3.3-70b"
...
register("lepton", LeptonProvider)
