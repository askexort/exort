"""
Ollama Cloud provider — cloud-hosted inference via ollama.com.
...
class OllamaCloudProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://ollama.com/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "nemotron-3-nano:30b"
...
register("ollama-cloud", OllamaCloudProvider)
