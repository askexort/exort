"""
Fireworks AI provider — fast inference, function-calling models.

Sign up: https://fireworks.ai  (free tier available)
"""
...
class FireworksProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.fireworks.ai/inference/v1"
        try:
    ...
    def chat(self, messages, model=None, tools=None, temperature=0.7,
        ...
        model = model or self.default_model or "accounts/fireworks/models/llama-v3p3-70b-instruct"
...
register("fireworks", FireworksProvider)
