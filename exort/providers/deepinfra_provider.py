"""
DeepInfra provider — affordable inference for popular open models.
...
class DeepinfraProvider(BaseProvider):
    ...
    def __init__(self, **kw):
        super().__init__(**kw)
        self.base_url = self.base_url or "https://api.deepinfra.com/v1/openai"
        try:
...
register("deepinfra", DeepinfraProvider)
